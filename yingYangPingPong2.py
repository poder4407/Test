...
# Variable para controlar el cierre al inicio
started = False
...
while True:
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            pygame.quit()
            sys.exit()
        elif event.type in [pygame.MOUSEMOTION, pygame.MOUSEBUTTONDOWN, pygame.KEYDOWN] and started:
            pygame.quit()
            sys.exit()
        started = True  # Cambiar el estado para habilitar el cierre en eventos de entrada después del primer ciclo
